...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1*N_INPUT_2_1>(in, flatten_22_input);
      result_t layer8_out[N_LAYER_6];

            // hls-fpga-machine-learning insert top-level-function
            myproject(flatten_22_input,layer8_out);
    ...
    input_t flatten_22_input[N_INPUT_1_1*N_INPUT_2_1];
    nnet::fill_zero<input_t, N_INPUT_1_1*N_INPUT_2_1>(flatten_22_input);
    result_t layer8_out[N_LAYER_6];
